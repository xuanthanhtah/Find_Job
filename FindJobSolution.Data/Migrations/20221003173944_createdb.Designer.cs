...
namespace FindJobSolution.Data.Migrations
{
    ...
    [Migration("20221003173944_createdb")]
            ...
            modelBuilder.Entity("FindJobSolution.Data.Entities.JobInformation", b =>
                {
                    ...
                    b.Property<DateTime>("JobInformationTimeEnd")
                        ...
                        .HasDefaultValue(new DateTime(2022, 10, 4, 0, 39, 44, 309, DateTimeKind.Local).AddTicks(2423));

                    b.Property<DateTime>("JobInformationTimeStart")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 10, 4, 0, 39, 44, 309, DateTimeKind.Local).AddTicks(2187));
            ...
            modelBuilder.Entity("FindJobSolution.Data.Entities.JobSeekerInApplyJob", b =>
                {
                    ...
                    b.Property<DateTime>("ApplyJobsTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 10, 4, 0, 39, 44, 311, DateTimeKind.Local).AddTicks(4471));
            ...
            modelBuilder.Entity("FindJobSolution.Data.Entities.JobSeekerInSaveJob", b =>
                {
                    ...
                    b.Property<DateTime>("TimeSaveJob")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 10, 4, 0, 39, 44, 311, DateTimeKind.Local).AddTicks(8385));
            ...
            modelBuilder.Entity("FindJobSolution.Data.Entities.JobInformation", b =>
                {
                    b.HasOne("FindJobSolution.Data.Entities.ApplyJob", "ApplyJob")
                        ...
                        .HasForeignKey("FindJobSolution.Data.Entities.JobInformation", "JobInformationId")
