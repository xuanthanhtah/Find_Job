...
namespace FindJobSolution.Data.Migrations
{
    ...
    [Migration("20221028103015_testallownulll")]
    partial class testallownulll
    {
            ...
            modelBuilder.Entity("FindJobSolution.Data.Entities.JobSeeker", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.IsSparse(b.Property<decimal>("DesiredSalary"), false);
            ...
            modelBuilder.Entity("FindJobSolution.Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "7e3e3c1a-2578-4c66-981c-ac802026dea0",
                            Name = "admin",
            ...
            modelBuilder.Entity("FindJobSolution.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "838c47ae-1d9d-4d4c-8364-e9a5d47a59fa",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEG3xOg54y7JHSQQprKtKHthsf4TfCgaCsa4uctqphnuehLvC1XU23vMav1MXSiYc0Q==",
